...
import nl.arthurvlug.hadoop.numbersort.OrderedTextSortComparator;

import org.apache.hadoop.io.Text;
import org.junit.Test;

public class OrderedTextSortComparatorTest {
	private static final double EPSILON = 0.000001;
	
	private OrderedTextSortComparator orderedTextSortComparator = new OrderedTextSortComparator();

	@Test
	public void zeroZero() {
		OrderedText o1 = new OrderedText(new Text("0"));
		OrderedText o2 = new OrderedText(new Text("0"));
		assertEquals(0, Math.signum(orderedTextSortComparator.compare(o1, o2)), EPSILON);
	}
	...
	public void posPos() {
		...
		assertEquals(-1, Math.signum(orderedTextSortComparator.compare(o1, o2)), EPSILON);
	}
	...
	@Test
	public void fourSeven() {
		OrderedText o1 = new OrderedText(new Text("4"));
		OrderedText o2 = new OrderedText(new Text("17"));
		assertEquals(-1, Math.signum(orderedTextSortComparator.compare(o1, o2)), EPSILON);
	}
